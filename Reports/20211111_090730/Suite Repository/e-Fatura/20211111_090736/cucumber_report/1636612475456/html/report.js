$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Fatura/Giden Kutusu/Uygulama Yanıtlari/Ekran Kontrolu.feature");
formatter.feature({
...
formatter.step({
  "name": "Tablodan 1234567806 isimli verinin detayı tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Tablodan 1234567806 isimli verinin detayı tıklanır",
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 01.05.2021 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 18.05.2021 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
