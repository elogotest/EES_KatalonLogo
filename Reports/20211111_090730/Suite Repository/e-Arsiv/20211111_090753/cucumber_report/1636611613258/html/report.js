$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Arsiv/e-Arsiv Hareketleri/e-Arsiv Raporlari/Ekran Kontrolu.feature");
formatter.feature({
...
formatter.step({
  "name": "Listelenen öğe bilgisi kayıt edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Listelenen öğe sayısı doğru mu",
  "keyword": "* "
});
formatter.step({
  "name": "Ana menüden e-Arşiv seçilir",
...
formatter.step({
  "name": "Filtrelerden Bölüm Tarihi filtresine \u003cfiltreDegeri1\u003e baslangic degerini yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan 2716453 isimli verinin detayı tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Tablodan 2716453 isimli verinin detayı tıklanır",
...
formatter.match({
  "location": "genel.ListelenenOgeKayitEdilir()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "genel.listelenenOgeSayisiDogruMu()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "Filtrelerden Dönem Tarihi filtresine 2021 Eylül dropdowndan degeri seçilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Bölüm Tarihi filtresine 01.09.2021 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Bölüm Tarihi filtresine 01.09.2021 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
