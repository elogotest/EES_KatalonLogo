$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Mustahsil Uygulamasi/e-Mustahsil Makbuzu Raporlari/Izleme Kayitlari.feature");
formatter.feature({
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        ...
        "09.01.2021",
        "2891",
        "Müstahsil Makbuzu Rapor İzleme Kayıtları"
      ]
    }
  ]
});
...
formatter.step({
  "name": "Müstahsil Makbuzu Rapor İzleme Kayıtları baslikli gecmis sayfasi geldi mi",
  "keyword": "* "
});
formatter.match({
