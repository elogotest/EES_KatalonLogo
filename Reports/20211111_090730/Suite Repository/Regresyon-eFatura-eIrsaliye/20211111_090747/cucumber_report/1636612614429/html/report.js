$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Fatura/VKN-Ticari Fatura-Ihrac Kayitli.feature");
formatter.feature({
...
formatter.step({
  "name": "Ön Ek EFA olarak seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Tasarım alanından Otomasyon seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ek Bilgiler Gönderen,BAYINO,2000 olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Kullanıcı adı TIFIHRAC ve Şifre test1234 olarak giriş yapılır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Alıcı adı alanına UC0029 girilir",
  "keyword": "* "
});
formatter.match({
