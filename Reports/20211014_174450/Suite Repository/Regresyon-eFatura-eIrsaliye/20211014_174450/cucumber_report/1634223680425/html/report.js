$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Downloads/EES_Katalon-main/Include/features/Regresyon/e-Fatura/VKN-Temel Fatura-Ozel Matrah.feature");
formatter.feature({
...
formatter.step({
  "name": "Kullanıcı adı TEFMATRAH ve Şifre test1234 olarak giriş yapılır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Alıcı adı alanına UC0026 girilir",
  "keyword": "* "
});
formatter.match({
