$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuz Raporlari/Izleme Kayitlari.feature");
formatter.feature({
...
formatter.scenarioOutline({
  "name": "e-Serbest Meslek Makbuz Raporlari",
  "description": "",
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        ...
        "11.01.2021",
        "1641",
        "Serbest Meslek Makbuzu Rapor İzleme Kayıtları"
      ]
    }
  ]
});
...
formatter.step({
  "name": "Serbest Meslek Makbuzu Rapor İzleme Kayıtları baslikli gecmis sayfasi geldi mi",
  "keyword": "* "
});
formatter.match({
