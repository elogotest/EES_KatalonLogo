$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Arsiv/VKN-Kagit-Tevkifat.feature");
formatter.feature({
...
formatter.step({
  "name": "Tabloda yeni oluşturulan eArsiv verisi başarılı mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Kullanıcı adı EARTEVKIFAT ve Şifre test1234 olarak giriş yapılır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Alıcı adı alanına UC0016 girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "tablo.tablodaVeriBasariliMiArsiv()"
});
formatter.result({
  "status": "skipped"
});
