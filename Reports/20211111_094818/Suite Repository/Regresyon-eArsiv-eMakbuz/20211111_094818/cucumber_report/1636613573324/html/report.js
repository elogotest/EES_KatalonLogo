$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Arsiv/VKN-Internet.feature");
formatter.feature({
  "name": "Gonderim tipi Internet tipinde e-Arsiv faturasi olusturulmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Fatura tipi alanından e-Arşiv İnternet seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Görsel tasarım sayfasının e-Arşiv Fatura (İnternet) Bilgileri başlığını içerdiği kontrol edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tasarım alanından e-Arşiv Öndeğer Şablon Tasarım seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Sipariş bilgileri UUC-SAT-1200001 ve 31.06.2021 olarak girilir",
  "keyword": "* "
});
formatter.step({
  "name": "İrsaliye Bilgileri AAAAAAAAAA,31.06.2021 olarak girilir",
  "keyword": "* "
});
formatter.step({
  "name": "e-Arşiv İnternet Bilgileri Kredi Kartı / Banka Kartı,www.elogo.com,1234567806,elogo,Virgosol olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.match({
  "location": "filtreler.faturaTipiSec()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.eArsivInternetBilgileri(String,String,String,String,String)"
});
formatter.result({
  "status": "skipped"
});
