$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Zarflar/Gelen Zarflar/Tablodaki Verinin Butonlari.feature");
formatter.feature({
...
formatter.step({
  "name": "Tablodaki \u003cveri_Adi1\u003e isimli verinin İrsaliyeler adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Yeni açılan sekmeye geçilir",
...
formatter.step({
  "name": "Tablodaki E LOGO 6 isimli verinin Uygulama Yanıtları adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodaki E LOGO 6 isimli verinin Faturalar adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
  "location": "tablo.tablodakiVerininButonunaTiklanir(String,String)"
