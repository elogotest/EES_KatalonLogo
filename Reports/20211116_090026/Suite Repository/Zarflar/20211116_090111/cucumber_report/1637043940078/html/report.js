$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Zarflar/Gelen Zarflar/Ekran Kontrolu.feature");
formatter.feature({
...
formatter.step({
  "name": "Tablodan Test Kurum 6 isimli verinin detayı tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Tablodan Test Kurum 6 isimli verinin detayı tıklanır",
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 01.11.2020 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 30.11.2020 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
