$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Arsiv/e-Arsiv Hareketleri/e-Arsiv Faturalari/Departman Ata-Geri Al.feature");
formatter.feature({
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvanı filtresine xcx cx textini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan xcx cx isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
