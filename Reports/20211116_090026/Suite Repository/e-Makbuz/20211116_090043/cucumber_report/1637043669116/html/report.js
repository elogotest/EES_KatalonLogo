$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuzlari/Izleme Kayitlari.feature");
formatter.feature({
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        ...
        "31.12.2020",
        "TEST",
        "Serbest Meslek Makbuzu İzleme Kayıtları"
      ]
    }
  ]
});
...
formatter.step({
  "name": "Serbest Meslek Makbuzu İzleme Kayıtları baslikli gecmis sayfasi geldi mi",
  "keyword": "* "
});
formatter.match({
