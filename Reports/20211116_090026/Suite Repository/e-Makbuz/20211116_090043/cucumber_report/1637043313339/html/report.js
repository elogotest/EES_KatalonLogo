$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuz Raporlari/GIBe Gonder.feature");
formatter.feature({
  "name": "e-Serbest Makbuzu Raporlari GIBe Gonder",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Popup mesajı makbuz sayısı 0 olduğu için GİB\u0027e gönderilemez içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan 1637 isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
