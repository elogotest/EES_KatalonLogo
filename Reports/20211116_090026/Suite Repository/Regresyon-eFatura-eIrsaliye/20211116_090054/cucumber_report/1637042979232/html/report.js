$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Fatura/VKN-Kamu-Satis.feature");
formatter.feature({
...
formatter.step({
  "name": "Kamu için Ödeme Bilgileri TR193739520062686063252625,Türk Lirası,3214525138 olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ürün ekleme alanında Mal/Hizmet başlığına virgosol girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Açıklaması başlığına oto girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Miktarı başlığına 300 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Birim Fiyat başlığına 50 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında İskonto Oranı % başlığına 10 girilir",
...
formatter.step({
  "name": "Kullanıcı adı KAMUSATIS ve Şifre test1234 olarak giriş yapılır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Alıcı adı alanına UC0021 girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "genel.kamuOdemeBilgileriIbanDovizVkn(String,String,String)"
});
formatter.result({
  "status": "passed"
});
