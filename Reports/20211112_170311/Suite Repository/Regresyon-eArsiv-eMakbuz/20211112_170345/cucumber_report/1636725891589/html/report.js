$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Arsiv/VKN-Elektronik-Hal Komisyoncu.feature");
formatter.feature({
...
formatter.step({
  "name": "Masraf Bilgileri alanında Masraf Oranı % başlığına 10 girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Kullanıcı adı HALKOMIS ve Şifre test1234 olarak giriş yapılır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Alıcı adı alanına UC0001 girilir",
  "keyword": "* "
});
formatter.match({
