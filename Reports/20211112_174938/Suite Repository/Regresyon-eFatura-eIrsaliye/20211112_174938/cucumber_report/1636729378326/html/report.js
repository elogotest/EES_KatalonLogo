$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Fatura/VKN-Temel Fatura-Iade.feature");
formatter.feature({
...
formatter.step({
  "name": "Döküman Para Birimi alanından ABD Doları seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Döviz kuru 8 belirlenir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Kullanıcı adı TEFIADE ve Şifre test1234 olarak giriş yapılır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Alıcı adı alanına UC0023 girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "genel.dovizKuruBelirlenir(String)"
});
formatter.result({
  "status": "passed"
});
