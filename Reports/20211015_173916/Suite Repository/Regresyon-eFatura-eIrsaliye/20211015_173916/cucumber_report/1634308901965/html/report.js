$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Downloads/EES_Katalon-main/Include/features/Regresyon/e-Fatura/VKN-Kamu-Istisna.feature");
formatter.feature({
...
formatter.step({
  "name": "Kullanıcı adı KAMUISTISNA ve Şifre test1234 olarak giriş yapılır",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Alıcı adı alanına UC0019 girilir",
  "keyword": "* "
});
formatter.match({
