$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Irsaliye/Temel Irsaliye Matbudan.feature");
formatter.feature({
...
formatter.step({
  "name": "İrsaliye tipi alanından Matbudan seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tasarım alanından VirgosolOtomasyon seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Matbu İrsaliye bilgileri FER2021000000411 ve 31.04.2020 olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan Irsaliye Ettn bilgisi kaydedilen veri seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.match({
  "location": "genel.irsaliyetipiSecilir()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "genel.matbuBilgileri(String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "tablo.tablodanIrsaliyeEttnliVeriSecilir()"
});
formatter.result({
  "status": "skipped"
});
