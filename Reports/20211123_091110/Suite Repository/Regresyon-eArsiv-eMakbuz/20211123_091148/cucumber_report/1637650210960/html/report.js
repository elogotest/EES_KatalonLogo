$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Serbest Meslek Makbuzu/VKN-e-Serbest Meslek Makbuzu-Elektronik.feature");
formatter.feature({
...
formatter.step({
  "name": "Tasarım alanından e-Serbest Meslek Makbuz Öndeger Sablon Tasarim.xslt- seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tabloda yeni oluşturulan smm verisi başarılı mı",
  "keyword": "* "
});
formatter.step({
