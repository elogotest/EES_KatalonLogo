$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuzlari/Ekran Kontrolu.feature");
formatter.feature({
...
formatter.step({
  "name": "Filtrelerden Makbuz Tarihi filtresine \u003cfatura_tarihi\u003e textini yaz",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre butonlarından Listele seçilir",
...
formatter.step({
  "name": "Butonlardan İptal Et / İtiraz Bildir var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Makbuz Tarihi filtresine 02.11.2020 textini yaz",
  "keyword": "* "
});
formatter.match({
