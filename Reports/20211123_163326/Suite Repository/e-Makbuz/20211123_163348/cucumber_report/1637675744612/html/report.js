$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuzlari/Statu Ata.feature");
formatter.feature({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 08.04.2021 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 08.04.2021 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
