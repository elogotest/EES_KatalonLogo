$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuzlari/Iptal Et-Geri Al.feature");
formatter.feature({
...
formatter.step({
  "name": "Butonlardan İptal Et / İtiraz Bildir isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Alt butonlardan İptal Et butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
