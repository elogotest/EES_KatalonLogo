$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Makbuz/e-Mustahsil Uygulamasi/e-Mustahsil Makbuzlari/Ekran Kontrolu.feature");
formatter.feature({
...
formatter.step({
  "name": "Tablodan ELOGO5 isimli verinin detayı tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Tablodan ELOGO5 isimli verinin detayı tıklanır",
...
formatter.step({
  "name": "Filtrelerden Makbuz Tarihi filtresine \u003cfatura_tarihi_baslangic\u003e baslangic degerini yaz",
  "keyword": "* "
});
formatter.step({
  "name": "Filtrelerden Makbuz Tarihi filtresine \u003cfatura_tarihi_bitis\u003e bitis degerini yaz",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre butonlarından Listele seçilir",
...
formatter.step({
  "name": "Filtrelerden Makbuz Tarihi filtresine 01.11.2020 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
  "location": "filtreler.filtreBaslangicYaz(String,String)"
...
formatter.step({
  "name": "Filtrelerden Makbuz Tarihi filtresine 27.11.2020 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
  "location": "filtreler.filtreBitisYaz(String,String)"
