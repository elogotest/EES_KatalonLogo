$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Zarflar/Giden Zarflar/Ekran Kontrolu.feature");
formatter.feature({
...
formatter.step({
  "name": "Sayfa butonlarından 1 numaralı sayfa butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Zarflar sayfa boyutu 20 olarak seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Zarflar sayfa boyutu 50 olarak seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Zarflar sayfa boyutu 10 olarak seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Giden zarflar altındaki zarfa git butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
...
formatter.match({
  "location": "butonlar.zarflarSayfaBoyutu(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "butonlar.zarfaGitGidenTikla()"
});
formatter.result({
  "status": "passed"
});
