$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Fatura/Gelen Kutusu/Faturalar/Statu Ata.feature");
formatter.feature({
...
formatter.step({
  "name": "Filtrelerden Belge statusu Öndeğer olarak secilir",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre butonlarından Listele seçilir",
...
formatter.match({
  "location": "filtreler.statuSecilir(String)"
});
formatter.result({
  "status": "passed"
});
