$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Fatura/Gelen Kutusu/Faturalar/Departman Ata-Geri Al.feature");
formatter.feature({
...
formatter.step({
  "name": "Atanan departman \u003cdepartman\u003e olarak secilir",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre butonlarından Listele seçilir",
...
formatter.step({
  "name": "Atanan departman otomasyon olarak secilir",
  "keyword": "* "
});
formatter.match({
  "location": "filtreler.atananDepartman(String)"
});
formatter.result({
  "status": "passed"
});
