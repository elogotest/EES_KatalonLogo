$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Downloads/EES_Katalon-main/Include/features/e-Arsiv/e-Arsiv Hareketleri/e-Arsiv Faturalari/Tablodaki Verinin Gorseli.feature");
formatter.feature({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 01.02.2020 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 29.02.2020 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodaki sena şahin isimli verinin Fatura adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
