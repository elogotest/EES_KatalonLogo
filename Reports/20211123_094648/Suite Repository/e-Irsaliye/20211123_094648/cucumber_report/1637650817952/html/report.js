$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/e-Irsaliye/e-Irsaliye Araclari/e-Irsaliye Olusturma/Ekle/TCKN-Temel Irsaliye-Sevk Tipinde.feature");
formatter.feature({
...
formatter.step({
  "name": "Farklı Teslimat Adres Tanımı adres,Türkiye,Isparta,Yalvaç,32400 olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "E-Irsaliye Ettn bilgisi kayıt edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Notlar alanına \u003cnot1\u003e girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Kaydet butonu seçilir",
...
formatter.step({
  "name": "Filtrelerden Irsaliye Ettn filtresine Ettn bilgisi yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tabloda yeni oluşturulan irsaliye verisi başarılı mı",
  "keyword": "* "
});
formatter.step({
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        ...
        "400",
        "100",
        "Otomasyon Sanal Kullanıcı",
        "Otomasyon Not Değiştir",
...
formatter.step({
  "name": "Alıcı adı alanına UC0045 girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "genel.farkliTeslimatAdresTanimi(String,String,String,String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "Notlar alanına Otomasyon Sanal Kullanıcı girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "genel.IrsaliyeEttnBilgisiKayitEdilir()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "Tabloda VirgosolOtomasyonTEST ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan VirgosolOtomasyonTEST isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Notlar alanına Otomasyon Not Değiştir girilir",
  "keyword": "* "
});
formatter.match({
  "location": "genel.notGirilir(String)"
...
formatter.match({
  "location": "filtreler.filtreIrsaliyeEttnYaz()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "Alıcı adı alanına UC0099 girilir",
  "keyword": "* "
});
formatter.match({
  "location": "genel.aliciSec(String)"
...
formatter.step({
  "name": "Ürün ekleme alanında Miktarı başlığına 350 girilir",
  "keyword": "* "
});
formatter.match({
  "location": "genel.malzemeMalHizmetBilgileriGirilir(String,String)"
...
formatter.step({
  "name": "Ürün ekleme alanında Birim Fiyat başlığına 150 girilir",
  "keyword": "* "
});
formatter.match({
  "location": "genel.malzemeMalHizmetBilgileriGirilir(String,String)"
...
formatter.step({
  "name": "Notlar alanına Otomasyon Gerçek Kullanıcı girilir",
  "keyword": "* "
});
formatter.match({
  "location": "genel.notGirilir(String)"
...
formatter.step({
  "name": "Tabloda Test Kurum 6 ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.match({
  "location": "tablo.tablodaUnvanliVeriOlusturulduMu(String)"
...
formatter.step({
  "name": "Tablodan Test Kurum 6 isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
  "location": "tablo.tablodanVeriSecilir(String)"
