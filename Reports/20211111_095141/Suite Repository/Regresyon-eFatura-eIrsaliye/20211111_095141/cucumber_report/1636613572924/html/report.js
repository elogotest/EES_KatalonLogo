$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Documents/GitHub/EES_KatalonLogo/Include/features/Regresyon/e-Fatura/VKN-Yolcu Beraber-Istisna.feature");
formatter.feature({
...
formatter.step({
  "name": "Turist alanına TuristAd,TuristSoyad,1111111111,25.01.2021,Almanya,Türkiye girilir",
  "keyword": "* "
});
formatter.step({
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        ...
        "100",
        "Otomasyon Not",
        "GÜMRÜK VE TİCARET BAKANLIĞI BİLGİ İŞLEM DAİRESİ BAŞKANLIĞI"
      ]
    }
  ]
});
