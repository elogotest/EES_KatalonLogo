$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/Users/DELL/Downloads/EES_Katalon-main/Include/features/e-Fatura/e-Fatura Araclari/e-Fatura Yukleme/Excele Aktar.feature");
formatter.feature({
...
formatter.step({
  "name": "Butonlardan Örnek Excel Şablonu isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan eLogoExcelFatura.xls isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
