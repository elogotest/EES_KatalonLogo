Feature: Gelen Kutusu Irsaliye Yanitlari Excel

  Scenario Outline: Gelen Kutusu Irsaliye Yanitlari Excel
    ...
    * Kullanıcı işlemlerinden Çıkış seçilir
    ...
    Examples: 
      ...
      | ELOGO6       | 123456 | RAL2022890080937  | 22.06.2022 | ali.kara@logo.com.tr |
