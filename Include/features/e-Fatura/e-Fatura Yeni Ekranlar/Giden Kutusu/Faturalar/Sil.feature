Feature: e-Fatura Giden Kutusu Faturalar Tekrar Sil

  Scenario Outline: e-Fatura Giden Kutusu Faturalar Sil
    ...
    * Menü altındaki seçeneklerden Sil isimli butona tıklanır
