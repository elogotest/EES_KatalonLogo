Feature: e-Fatura Giden Kutusu Faturalar Ekran Kontrolü

  Scenario Outline: e-Fatura Giden Kutusu Faturalar Ekran Kontrolü
    ...
    * Yeni ekranlar Filtre başlıklarından Okunma Durumu var mı
