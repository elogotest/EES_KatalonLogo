Feature: Yeni olusturma ekranı Ticari Fatura  ve İhrac Kayıtlı tipinde e-Fatura olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Ticari Fatura  ve İhrac Kayıtlı tipinde e-Fatura olusturulmasi
    ...
    * Tabloda veri var mı kontrol edilir
    * e-Fatura oluşturulan faturanın tutar bilgisi 121.000,00  ile aynı mı
