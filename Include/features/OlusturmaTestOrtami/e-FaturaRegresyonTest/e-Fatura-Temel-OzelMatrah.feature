Feature: Yeni olusturma ekranı Temel Fatura  ve Özel Matrah tipinde e-Fatura olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Ticari Fatura  ve Özel Matrah tipinde e-Fatura olusturulmasi
