Feature: Yeni olusturma ekranı Ticari Fatura  ve Tevkifat İade tipinde e-Fatura olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Ticari Fatura  ve Tevkifat İade tipinde e-Fatura olusturulmasi
