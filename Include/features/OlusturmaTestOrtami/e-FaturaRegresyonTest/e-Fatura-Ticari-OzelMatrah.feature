Feature: Yeni olusturma ekranı Ticari Fatura  ve Ozel Matrah tipinde e-Fatura olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Ticari Fatura  ve Ozel Matrah tipinde e-Fatura olusturulmasi
