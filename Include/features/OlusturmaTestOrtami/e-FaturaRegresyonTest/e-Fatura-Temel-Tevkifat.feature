Feature: Yeni olusturma ekranı Temel Fatura  ve Tevkifat tipinde e-Fatura olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Temel Fatura  ve Tevkifat tipinde e-Fatura olusturulmasi
    ...
    * Yeni olusturma ekranı Tip alanından Tevkifat seçilir
    ...
    * Tabloda veri var mı kontrol edilir
    * e-Fatura oluşturulan faturanın tutar bilgisi 142.780,00 ile aynı mı
