Feature: Yeni olusturma ekranı Temel Fatura  ve İstisna tipinde e-Fatura olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Ticari Fatura  ve Istisna tipinde e-Fatura olusturulmasi
