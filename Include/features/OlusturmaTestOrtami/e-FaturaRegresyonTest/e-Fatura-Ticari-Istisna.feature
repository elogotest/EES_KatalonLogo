Feature: Yeni olusturma ekranı Ticari Fatura  ve İstisna tipinde e-Fatura olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Ticari Fatura  ve İstisna tipinde e-Fatura olusturulmasi
