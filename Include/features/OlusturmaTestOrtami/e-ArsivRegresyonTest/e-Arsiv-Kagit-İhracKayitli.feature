Feature: Yeni olusturma ekranı Gönderim tipi Kagit ve İhrac Kayitli tipinde e-Arsiv faturasi olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Gönderim tipi Kagit ve İhrac Kayitli tipinde e-Arsiv faturasi olusturulmasi
