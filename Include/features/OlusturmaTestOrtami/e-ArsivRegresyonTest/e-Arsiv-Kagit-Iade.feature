Feature: Yeni olusturma ekranı Gönderim tipi Kagit ve İade tipinde e-Arsiv faturasi olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Gönderim tipi Kagit  ve İade tipinde e-Arsiv faturasi olusturulmasi
