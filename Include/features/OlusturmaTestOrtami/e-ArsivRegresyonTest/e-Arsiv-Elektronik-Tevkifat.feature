Feature: Yeni olusturma ekranı Gönderim tipi Elektronik ve Tevkifat tipinde e-Arsiv faturasi olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Gönderim tipi Elektronik  ve Tevkifat tipinde e-Arsiv faturasi olusturulmasi
