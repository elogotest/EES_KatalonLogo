Feature: Yeni olusturma ekranı Gönderim tipi Elektronik ve Özel Matrah tipinde e-Arsiv faturasi olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Gönderim tipi Elektronik  ve Özel Matrah tipinde e-Arsiv faturasi olusturulmasi
