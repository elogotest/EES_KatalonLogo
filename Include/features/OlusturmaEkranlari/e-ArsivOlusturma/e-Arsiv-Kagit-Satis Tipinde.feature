Feature: Yeni olusturma ekranı Gönderim tipi Kagit ve Satis tipinde e-Arsiv faturasi olusturulmasi

  Scenario Outline: Yeni olusturma ekranı Gönderim tipi Kagit ve Satis tipinde e-Arsiv faturasi olusturulmasi
