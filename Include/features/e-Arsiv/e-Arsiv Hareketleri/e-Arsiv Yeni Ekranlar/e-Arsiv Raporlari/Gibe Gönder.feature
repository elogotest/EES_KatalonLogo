Feature: e-Arsiv Raporları Gibe Gönder

  Scenario Outline: e-Arsiv Raporları Gibe Gönder
    ...
    * Menü altındaki seçeneklerden GİB'e Gönder isimli butona tıklanır
    * Yeni ekranlar yönetim popup butonlarından Tamam seçilir
    #* Yeni ekranlar popup mesajı Gib'e gönderilmeyen içeriyor mu
