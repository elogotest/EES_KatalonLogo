...
CustomKeywords.'Method.TextDegerineEsitElementVarMi'(findTestObject("Tablo/DurumBilgisiIrsaliye"), "Hatalı (GIB kullanıcı listesinde (0748742193, urn:mail:irsaliyepk@gib.gov.tr) ikilisine ait kayıtlı kullanıcı bulunamadı)")